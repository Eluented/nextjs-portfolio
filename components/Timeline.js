  ...
  return (
    <>
      <div className="antialiased min-h-screen">
        <div className="relative container mx-auto px-6 flex flex-col space-y-28 pb-16 md:pb-12">
          {/* First Timestamp */}
            ...
            <div className="bubble text-bubble relative pt-2 xs:pl-28 xs:pt-0 md:w-1/2 md:pl-0 md:pr-16 md:ml-0 md:mr-auto">
              ...
              <div className="test bg-slate-100 p-6 rounded-lg shadow-md  tracking-wide">
                ...
                <p className="pt-1 text-black">
                  ...
                  Personal and Professional Development, Research Project and
                  Audit.
                </p>
              </div>
            </div>
          ...
          {/* Second Timestop */}
          <div className="relative z-10 ">
            <div className="devSVG svg-container w-[6rem] h-[6rem] p-4 rounded-full shadow-md  bg-cyan-600 xs:absolute md:mx-auto md:left-0 md:right-0">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            <div className="bubble2 text-bubble relative pt-2 xs:pl-28 xs:pt-0 md:w-1/2 ml-auto md:pl-16 ">
              ...
              <div className="test bg-slate-100 p-6 rounded-lg shadow-md  tracking-wide">
                ...
                <p className="pt-1 text-black">
                  ...
                  Node.js, Express, Databases using SQL and NoSQL, React, Redux,
                  DevOps, Python including Django and Flask frameworks.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bubble3 text-bubble relative pt-2 xs:pl-28 xs:pt-0 md:w-1/2 md:pl-0 md:pr-16 md:ml-0 md:mr-auto">
              ...
              <div className="test  bg-slate-100 p-6 rounded-lg shadow-md  tracking-wide">
                ...
                <p className="pt-1 text-black">
                  ...
                  Agile & Scrum, Version Control, SQL, Java, OOP, SOLID
                  Principles, Design Patterns, Unit Testing (JUnit), File I/O,
                  JDBC, REST APIs, Spring Boot, Thymeleaf, Bootstrap
                </p>
              </div>
            </div>
          </div>
